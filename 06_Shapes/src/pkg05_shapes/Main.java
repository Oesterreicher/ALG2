...
public class Main {
     ...
     */
    public static ArrayList<Shape> shapes3;
    ...
    public static void main(String[] args) {
        ...
        shapes3 = new ArrayList<>(); //dynamicke pole objektov typu Shape
        ...
        double allArea3 = 0;
        double allCircumference = 0;
        for (Shape shape : shapes3) { //foreach
            allArea3 += shape.computeArea(); //polymorfism
            allCircumference += shape.computeCircumference();
        }
        System.out.println(allArea3);
        System.out.println(allCircumference);
        
        System.out.println("-----");
        MyComparing.main(null);
    }
}